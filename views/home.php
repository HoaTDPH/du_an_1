                ...
                <div class="row row-20 mtn-20">
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="assets/img/banner/banner6.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-lg-6">
                        <div class="group-product-banner">
                            <figure class="banner-statistics">
                                <a href="#">
                                    <img src="https://static.vecteezy.com/system/resources/previews/023/867/289/large_2x/polo-ralph-lauren-brand-logo-white-symbol-clothes-design-icon-abstract-illustration-with-blue-background-free-vector.jpg" alt="product banner">
                                </a>
                    ...
                    <div class="col-12">
                        <div class="brand-logo-carousel slick-row-10 slick-arrow-style">
                            ...
                            <div class="brand-item">
                                <a href="#">
                                    <img src="assets/img/brand/anh1234.jpg" alt="">
                                </a>
                            </div>
                            <!-- single brand end -->
